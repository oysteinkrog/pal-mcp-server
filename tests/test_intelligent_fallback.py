...
class TestIntelligentFallback:
    ...
    def test_prefers_openai_o3_mini_when_available(self):
        """Test that gpt-5.4 is preferred when OpenAI API key is available (based on new preference order)"""
        ...
        assert fallback_model == "gpt-5.4"  # Based on new preference order: gpt-5.4 before gpt-5.2
