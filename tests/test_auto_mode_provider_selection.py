...
class TestAutoModeProviderSelection:
    ...
    def test_gemini_only_fallback_selection(self):
        ...
        try:
            ...
            assert extended_reasoning in ["gemini-3.1-pro-preview", "gemini-3.5-flash", "gemini-2.5-pro", "pro"]
    ...
    def test_openai_only_fallback_selection(self):
        ...
        try:
            ...
            assert extended_reasoning == "gpt-5.6-sol"  # GPT-5.6 Sol prioritized for extended reasoning
            assert fast_response == "gpt-5.6-luna"  # gpt-5.6-luna comes first in fast response preference
            assert balanced == "gpt-5.6-terra"  # gpt-5.6-terra for balanced
